...
<form method="POST" action="<?php echo url('produtos/editar/' . $produto['id']); ?>" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            ...
            <?php if (!empty($produto['imagem'])): ?>
                <div class="mt-2">
                    <img src="<?php echo url('uploads/' . $produto['imagem']); ?>" class="img-thumbnail" style="max-height:80px;">
                </div>
            <?php endif; ?>
        </div>
    </div>
    <div class="mb-3">
        ...
        <textarea name="observacoes" class="form-control"><?php echo e($produto['observacoes']); ?></textarea>
    </div>
